  ...
  return (
    <div className="flex flex-col w-full h-full overflow-y-auto scroll-smooth space-y-4 pb-4">
      ...
      <Card className="flex flex-col gap-2 rounded-md p-3">
        ...
        <Separator />
        <DetailBadge title="Video Title" desc={title} showSpace />
        <DetailBadge title="Video Description" desc={description} showSpace />
        <Separator />
        ...
        <Card className="flex flex-col gap-2 rounded-md p-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-y-2">
            ...
            <DetailBadge
              ...
              desc={`${format(
                parseISO(transcription!.createdAt),
                "yyyy-MM-dd"
              )}`}
            />
          </div>
...
export const DetailBadge = ({
  ...
  return (
    <div className="flex flex-col ">
      ...
      >
        {showSpace && <span className="w-5 inline-block" />}
        {desc}
      </p>
    </div>
  );
